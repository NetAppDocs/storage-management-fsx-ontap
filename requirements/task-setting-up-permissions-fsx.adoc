...
.. Select *Required external ID* and copy and paste the external ID from *Workloads* in the NetApp Console user interface.
...
The credentials are created and viewable on the Credentials page. You can now use the credentials when creating an FSx for ONTAP file system. Whenever required, you can rename credentials or remove them from the NetApp Console.
