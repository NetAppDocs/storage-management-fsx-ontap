...
Replicate data to support backup and disaster recovery. Data replication is supported between FSx for ONTAP file systems and on-premises ONTAP systems or Cloud Volumes ONTAP. 
...
.. *Target name*: The target name was applied when you dragged and dropped the source system on the target system in the Console Systems page. 
