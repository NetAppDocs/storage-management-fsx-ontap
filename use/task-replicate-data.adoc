...
When you replicate a source volume with immutable files, the target volume and file system stay locked until the retention period of the immutable files in the source volume ends. The immutable files feature is available when you link:https://docs.netapp.com/us-en/workload-fsx-ontap/create-volume.html[create a volume] for an FSx for ONTAP file system. 
