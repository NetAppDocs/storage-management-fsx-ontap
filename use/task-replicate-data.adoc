...
= Replicate data with Amazon FSx for NetApp ONTAP
:icons: font
:imagesdir: ../media/
...
link:https://docs.netapp.com/us-en/workload-fsx-ontap/change-tiering-policy.html[Modify the tiering policy] for the target volume(s) after cutover.
